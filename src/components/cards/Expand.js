...
const Expand = (props) => {
  ...
  const handleClick = (e) => {
    if (e.target.classList.contains("backdrop")) {
      ...
      setIndex(-2);
      console.log(
        "Artwork " + selectedArtwork.getName() + "\t Index: " + index,
      );
    }
  };
  ...
  return (
    <div className="backdrop" onClick={handleClick} style={{ zIndex: index }}>
      <div className="splitscreen">
        <img
          className="image"
          src={selectedArtwork.getSrc()}
          id={selectedArtwork.getName() + "-expand"}
          alt="enlarged Image"
        />
        <div className="description">
          ...
          <Button
            ...
            buttonStyle={"btn--add-to-bag"}
            click={() => addItem(selectedArtwork)}
          >
            Add to bag
          </Button>
        </div>
